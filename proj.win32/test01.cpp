    ...
    int       nCmdShow)
{
    ...
    return Test01Player::createAndRun();
}

int Test01Player::createAndRun(void)
{
    Test01Player *host = Test01Player::sharedInstance();
    int ret = host->run();
    Test01Player::purgeSharedInstance();
    return ret;
}

Test01Player *Test01Player::s_sharedInstance = NULL;

Test01Player *Test01Player::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new Test01Player();
    }
    return s_sharedInstance;
}

void Test01Player::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
Test01Player::Test01Player(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int Test01Player::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "test01-player");
...
void Test01Player::loadProjectConfig(void)
{
    vector<string> args;
...
void Test01Player::createViewMenu(void)
{
...
void Test01Player::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void Test01Player::updateWindowTitle(void)
{
}

void Test01Player::relaunch(void)
{
...
void Test01Player::writeDebugLog(const char *log)
{
...
// menu callback
void Test01Player::onFileOpenProject(void)
{
...
void Test01Player::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"Test01Player");
...
void Test01Player::onFileProjectConfig(void)
{
...
void Test01Player::onFileRelaunch(void)
{
    relaunch();
}

void Test01Player::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void Test01Player::onViewChangeFrameSize(int viewMenuID)
{
...
void Test01Player::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void Test01Player::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void Test01Player::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT Test01Player::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    Test01Player *host = Test01Player::sharedInstance();
...
INT_PTR CALLBACK Test01Player::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
